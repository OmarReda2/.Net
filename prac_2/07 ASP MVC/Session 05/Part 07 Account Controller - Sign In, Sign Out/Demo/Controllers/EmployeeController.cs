...
namespace Demo.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create(EmployeeViewModel employee)
        {
            ...
            {
                employee.ImageName = DocumentSetting.UploadFile(employee.Image, "Imgs"); 
                //use the uploadFile func. to save the the file in server "wwwroot" and save the file name in the database as we get all these information from the employee parameter which come from the view
                // add to submit form in the view
