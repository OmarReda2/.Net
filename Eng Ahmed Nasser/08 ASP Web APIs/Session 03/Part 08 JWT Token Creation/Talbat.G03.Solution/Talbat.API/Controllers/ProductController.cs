...
{
    //[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)] /// make the contoller accessable only for logned users(authorized) + identify jwt scheme
    [Authorize] /// we identifty the validation of jwt on "IdentityServiceExtension" as we make it global
